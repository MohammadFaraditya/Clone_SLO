...
def generate_template():
    df = pd.DataFrame(columns=["prlin", "prlinname", "pcode", "pcodename", "unit1", "unit2", "unit3", "convunit2", "convunit3", "sellprice1", "sellprice2", "sellprice3"])
    buffer = BytesIO()
...
def process_upload(file, username):
    ...
    # Validasi kolom
    required_cols = ["prlin", "prlinname", "pcode", "pcodename", "unit1", "unit2", "unit3", "convunit2", "convunit3", "sellprice1", "sellprice2", "sellprice3"]
